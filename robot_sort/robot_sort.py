class SortingRobot:
    ...
    def sort(self):
        ...
        # Based on the constraints laid out in the readme the sort we are
        # to do feels like a Selection.
        # the robot will pick up the first item since that is lowest known item
        # loop through and check each index to see if the current index is
        # less than what we are holding if not keep it if it is swap the items in place
